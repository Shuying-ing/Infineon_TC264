...
#define SDA             gpio_get (SEEKFREE_SDA1)
#define SDA0()          gpio_set (SEEKFREE_SDA1, 0)		//IO口输出低电平
#define SDA1()          gpio_set (SEEKFREE_SDA1, 1)		//IO口输出高电平
#define SCL0()          gpio_set (SEEKFREE_SCL1, 0)		//IO口输出低电平
#define SCL1()          gpio_set (SEEKFREE_SCL1, 1)		//IO口输出高电平
#define DIR_OUT()       gpio_dir (SEEKFREE_SDA1, GPO, PUSHPULL)   //输出方向
#define DIR_IN()        gpio_dir (SEEKFREE_SDA1, GPI, NO_PULL)    //输入方向
...
void simiic_init(void)
{
	...
	gpio_init (SEEKFREE_SDA1, GPO, 1, PUSHPULL);
}
